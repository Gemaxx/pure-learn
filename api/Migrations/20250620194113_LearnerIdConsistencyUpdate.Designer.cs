...
namespace api.Migrations
{
    ...
    [Migration("20250620194113_LearnerIdConsistencyUpdate")]
    partial class LearnerIdConsistencyUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.TimerSettings", b =>
                {
                    ...
                    b.Property<int>("CyclesBeforeLongBreak")
                        .HasColumnType("int")
                        .HasColumnName("cycles_before_long_break");
                    ...
                    b.Property<long>("LearnerId1")
                        .HasColumnType("bigint");

                    b.Property<int>("LongBreakMin")
                        .HasColumnType("int")
                        .HasColumnName("long_break_min");

                    b.Property<int>("ShortBreakMin")
                        .HasColumnType("int")
                        .HasColumnName("short_break_min");
            ...
            modelBuilder.Entity("api.Models.TimerSettings", b =>
                {
                    b.HasOne("api.Models.Learner", null)
                        .WithOne()
                        .HasForeignKey("api.Models.TimerSettings", "LearnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

...
export default function ResourcesTab({ resourceTypes, onAddResourceType, onAddResource }: ResourcesTabProps) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        >
          <div className="flex justify-between items-center mb-4">
            ...
            >
              Not-Started <span className="text-sm"></span>
            </h2>
            <button
              onClick={() => {
        ...
        >
          <div className="flex justify-between items-center mb-4">
            ...
            >
              In-Progress <span className="text-sm"></span>
            </h2>
            <button
              onClick={() => {
        ...
        >
          <div className="flex justify-between items-center mb-4">
            ...
            >
              On-Hold <span className="text-sm"></span>
            </h2>
            <button
              onClick={() => {

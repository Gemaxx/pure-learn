...
export function ResourceTypeForm({ onCancel, onSuccess }: ResourceTypeFormProps) {
  ...
  return (
    <div className={`w-full max-w-md mx-auto ${theme === "dark" ? "bg-black" : "bg-white"} p-6 rounded-lg shadow-lg`}>
      <h1 className={`text-xl font-semibold ${theme === "dark" ? "text-white" : "text-gray-900"} mb-6`}>
        Create Resource Type
      </h1>

      <form onSubmit={handleSubmit}>
        <div className="mb-6">
          <label htmlFor="name" className={`block ${theme === "dark" ? "text-white" : "text-gray-700"} mb-2`}>
            Name
          </label>
          <div className="relative">
            ...
            />
            <span
              className={`absolute right-2 bottom-2 text-xs ${theme === "dark" ? "text-zinc-500" : "text-gray-500"}`}
            >
              {name.length}/100
            </span>
          </div>
        ...
        <div className="mb-8">
          <label htmlFor="units" className={`block ${theme === "dark" ? "text-white" : "text-gray-700"} mb-2`}>
            Units
          </label>
          <div className="relative">
            <Input

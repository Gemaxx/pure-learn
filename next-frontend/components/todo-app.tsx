...
export default function TodoApp() {
  ...
  return (
    <div className="rounded-lg border border-purple-800 bg-background text-foreground overflow-hidden shadow-lg">
                ...
                <div className="flex-1 flex justify-between items-start">
                  ...
                  <div className="flex items-center gap-1">
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-6 w-6 p-0 text-muted-foreground hover:text-green-500 hover:bg-muted"
      ...
      <div className="border-t p-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-muted-foreground/60">Max Tasks: ex. 1</span>
        </div>
      </div>
    </div>
  )

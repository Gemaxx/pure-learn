...
const API_BASE_URL =
  process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:5115/api";
...
export function ResourceTypeForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const url = `${API_BASE_URL}/learners/${learnerId}/learningResourceTypes`;
        ...
        <div className="mb-8">
          ...
          <div className="relative">
            <Input
              id="unitType"
              value={unitType}
              onChange={(e) => setunitType(e.target.value.slice(0, 100))}

...
namespace Demo
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<Mdatabase>(optios => {
                optios.UseSqlServer("Server=DESKTOP-0PO2O1R;Database=Project;User Id=username;Password=password;Trusted_Connection=true;Encrypt=False");
            });
            services.AddIdentity<ApplicationUser, IdentityRole>()
                .AddEntityFrameworkStores<Mdatabase>();

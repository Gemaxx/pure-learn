...
import { createGoal, type Goal, type CreateGoalParams } from "@/services/api-client"
...
export function GoalFormModal({ isOpen, onClose, onSuccess, categoryId }: GoalFormModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Create Goal" className="max-h-[90vh] overflow-hidden">
